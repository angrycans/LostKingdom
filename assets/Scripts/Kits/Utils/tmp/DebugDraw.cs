...
namespace Acans.Tools
{
  ...
  public class DebugDraw : MonoBehaviour
  {
    ...
    public void drawRectangle(Vector2 v0, Vector2 v1)
    {
    ...
    public void drawRectangleOutline(Vector2 v0, Vector2 v1)
    {
    ...
    public Vector3[] ToVector3(Vector2[] vectors)
    {
      return System.Array.ConvertAll<Vector2, Vector3>(vectors, v => v);
    }

    public Vector3[] getVertices(Vector2 v0, Vector2 v1)
    {
      ...
      return this.ToVector3(rectangleVertices);



    }
    public Mesh createRectangleMesh(Vector2 v0, Vector2 v1, Color fillColor)
    {
      // Calculate implied verticies from corner vertices
      // Note: vertices must be adjacent to each other for Triangulator to work properly
      var v2 = new Vector2(v0.x, v1.y);
      ...
      {
        name = "Rectangle",
        vertices = this.ToVector3(rectangleVertices),
        triangles = triangles,
        colors = colors
      };
