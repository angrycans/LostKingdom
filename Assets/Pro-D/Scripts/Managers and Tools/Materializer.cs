...
namespace ProD
{
	public class Materializer : Singleton<Materializer>
	{
		...
		public void MaterializeMap(Map map)
		{
          ...
          //Debug.Log("cell orientation "+orientation[0]+" "+orientation[1]);
      ...
      Log.info("[",address.x,address.y,"]=", prefab_X,prefab_Y,prefab_Z,orientation[0],orientation[1]);
      ...
      UItextGO.transform.SetParent(cellGO.transform);

      RectTransform trans = UItextGO.AddComponent<RectTransform>();
      trans.anchoredPosition = new Vector2(10, 10);
